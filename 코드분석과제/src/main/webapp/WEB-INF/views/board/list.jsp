...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=520fa59145415d26c90c57934c778049"></script>
        ...
        $(document).ready(function () {
            ...
            $("#search").click(function () {
                ...
                $.ajax({
                    ...
                    headers: {"Authorization": "KakaoAK 87ed6cb96dcaa9952b9931106d92c611"},
                    type: "get",
                    data: {"query": bookname},
                    dataType: "json",
                    success: book,
                    ...
                    <c:forEach var="vo" items="${list}">
                        <tr>
                            ...
                            <td><c:if test="${vo.boLevel>0}">
                                ...
                                <c:if test="${vo.boLevel>0}">
                                    <c:if test="${vo.boUsable==1}">
                                        <a class="moving" href="${vo.idx}">
											<c:out value='[RE]${vo.title}'/></a>
                                    </c:if>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-append">
                                <select name="type" class="form-control">
                                    <option value="writer"
                                    ${pageCre.cri.type=='writer' ? 'selected' : ''}>이름
                                    </option>
                                    <option value="title"
                                    ${pageCre.cri.type=='title' ? 'selected' : ''}>제목
                                    </option>
                                    <option value="content"
                                    ${pageCre.cri.type=='content' ? 'selected' : ''}>내용
                                    </option>
                                </select>
                            </div>
                ...
                <form id="pageFrm" action="${root}/board/list" method="post">
                    ...
                    <input type="hidden" id="page" name="page"
                           value="${pageCre.cri.page}"/> <input type="hidden"
                                                                name="perPageNum" value="${pageCre.cri.perPageNum}"/>
